...
class EarthquakeApi:
    ...
    def getParsedDataTXT (self, startDate, endDate, fileLocation, verbose=True):
        """
                    ...
                    while 1: # Will keep trying to get data even if the ip is temporarily banned from making requests.
                        try:
                            ...
                            for feature in response["features"]:
                                ...
                                outfile.write("{};{};{};{};{};{};{}\n".format(title, event_time, mag, latitude, longitude, depth, url)) # Using ";" as the deliminator
