...
class EarthquakeApi:
    ...
    def getAllData(self, startDate, endDate, fileLocation):
        """
    ...
    def getParsedData(self, startDate, endDate, fileLocation):
        """
    ...
    def getLast24Hours(self):
        ...
        print("{}query?format=geojson&starttime={}&endtime={}".format(self.url, (date.today() - timedelta(days = 1)), date.today()))
